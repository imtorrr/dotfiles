...
install_dependencies() {
  ...
  if [[ "$OS" == "Darwin" ]]; then
    ...
    brew install bat zoxide uv google-cloud-sdk tmux neovim fzf
  elif [[ "$OS" == "Linux" ]]; then
    ...
    sudo apt-get install -y build-essential curl git zsh bat zoxide tmux neovim fzf google-cloud-cli
